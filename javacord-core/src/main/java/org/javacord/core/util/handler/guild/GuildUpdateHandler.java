    ...
    public void handle(JsonNode packet) {
        ...
        api.getAllServerById(id).map(server -> (ServerImpl) server).ifPresent(server -> {
            ...
            if (!Objects.deepEquals(oldName, newName)) {
                ...
                EventDispatchUtil.dispatchToServerChangeNameListeners(
                        server,
                        server,
                        api,
            ...
            if (!Objects.deepEquals(oldIconHash, newIconHash)) {
                ...
                EventDispatchUtil.dispatchToServerChangeIconListeners(
                        server,
                        server,
                        api,
            ...
            if (!Objects.deepEquals(oldSplashHash, newSplashHash)) {
                ...
                EventDispatchUtil.dispatchToServerChangeSplashListeners(
                        server,
                        server,
                        api,
            ...
            if (newVerificationLevel != oldVerificationLevel) {
                ...
                EventDispatchUtil.dispatchToServerChangeVerificationLevelListeners(
                        server,
                        server,
                        api,
            ...
            if (oldRegion != newRegion) {
                ...
                EventDispatchUtil.dispatchToServerChangeRegionListeners(
                        server,
                        server,
                        api,
            ...
            if (newDefaultMessageNotificationLevel != oldDefaultMessageNotificationLevel) {
                ...
                EventDispatchUtil.dispatchToServerChangeDefaultMessageNotificationLevelListeners(
                        server,
                        server,
                        api,
            ...
            if (!api.getCachedUserById(newOwnerId).map(oldOwner::equals).orElse(false)) {
                ...
                EventDispatchUtil.dispatchToServerChangeOwnerListeners(
                        server,
                        server,
                        api,
            ...
            if (packet.has("system_channel_id")) {
                ...
                if (oldSystemChannel != newSystemChannel) {
                    ...
                    EventDispatchUtil.dispatchToServerChangeSystemChannelListeners(
                            server,
                            server,
                            api,
            ...
            if (packet.has("afk_channel_id")) {
                ...
                if (oldAfkChannel != newAfkChannel) {
                    ...
                    EventDispatchUtil.dispatchToServerChangeAfkChannelListeners(
                            server,
                            server,
                            api,
            ...
            if (oldAfkTimeout != newAfkTimeout) {
                ...
                EventDispatchUtil.dispatchToServerChangeAfkTimeoutListeners(
                        server,
                        server,
                        api,
            ...
            if (oldExplicitContentFilterLevel != newExplicitContentFilterLevel) {
                ...
                EventDispatchUtil.dispatchToServerChangeExplicitContentFilterLevelListeners(
                        server,
                        server,
                        api,
            ...
            if (oldMultiFactorAuthenticationLevel != newMultiFactorAuthenticationLevel) {
                ...
                EventDispatchUtil.dispatchToServerChangeMultiFactorAuthenticationLevelListeners(
                        server,
                        server,
                        api,
